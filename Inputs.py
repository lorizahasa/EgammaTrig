...
# Histogramming
#---------------
outDir  = "%s/%s"%(eosDir, "HistNano_Pt31")
# for condor jobs
samples = {}
...
forOverlay.append("HistNano_Pt27/EGamma_Run2023C")
forOverlay.append("HistNano_Pt32/EGamma_Run2023C")

forRatio = []
#forRatio.append(["EGamma_Run2023C", "EGamma_Run2022G"])
#forRatio.append(["EGamma0_Run2023C", "EGamma1_Run2023C"])
forRatio.append(["HistNano_Pt27/EGamma_Run2023C", "HistNano_Pt31/EGamma_Run2023C"])
